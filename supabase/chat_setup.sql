-- =========================================================
-- STUDY LAB — UNIFIED BACKEND SETUP
--
-- The old chat-only setup is now unified with the student
-- account, profile, favorites and study-progress backend.
--
-- Run this file OR:
--   supabase/studylab_backend_setup.sql
--
-- Both are intentionally kept equivalent so there is no
-- ambiguity about which setup script to use.
-- =========================================================
